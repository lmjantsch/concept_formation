        ...
        try:
            ...
            with llm.trace(batch) as tracer:         
                ...
                for i, layer in enumerate(llm.model.layers[layer_slice]):
                    ...
                    batch_cache[f'{i}.attn_weight'] = attn_weight.cpu().save()
                    ...
                    batch_cache[f'{i}.activation_product'] = activation_product.cpu().save()
...
def parse_arguments():
    ...
    parser.add_argument("--output_base_dir", type=str, default="/raid/dacslab/CONCEPT_FORMATION/homograph_small_compressed", help="Base output directory")
